        ...
        <div className="px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-80px" }} transition={{ duration: 0.55, ease: [0.22, 1, 0.36, 1] }}>
            ...
            <div style={{ marginTop: "20px" }}>
              <p style={{ fontFamily: "var(--font-body)", fontSize: "16px", color: "#6B7280" }}>Start with the diagnostic.</p>
              <p style={{ fontFamily: "var(--font-body)", fontSize: "16px", color: "#6B7280" }}>Rs. 999. Thirty minutes.</p>
              <p style={{ fontFamily: "var(--font-body)", fontSize: "16px", color: "#6B7280" }}>Your business, mapped.</p>
            </div>
